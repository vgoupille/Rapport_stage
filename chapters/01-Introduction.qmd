...
-   nous focus sur microSPLiT stratégie qui est derivé de la SPLiTseq pour les eucaryotes (=\> voir matériels et methodes pour l'explication de la méthode )[@nishimura2025]
It's a high-throughput single-cell RNA sequencing method for bacteria. 
The microSPLiT technology was developed from SPLiT-seq16, a combinatorial split-pool scRNA-seq technology for eukaryotic cells.

-nombreux defi pour les bactéries : faire la liste ici

et pour le moment pas d'outils pour le moment vraiment adaptés ... [@ostner]
